...
export const actionChangeStrokeColor = register({
  ...
  PanelComponent: ({ elements, appState, updateData, appProps: _appProps }) => (
    <>
  ...
  PanelComponent: ({ elements, appState, updateData, app }) => {
    const options: {
      ...
      },
      {
        ...
        text: t("labels.xiaolai"),
        icon: FontFamilyXiaolaiIcon,
        testId: "font-family-xiaolai",
      },
    ];
