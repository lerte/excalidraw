...
export const FontFamilyXiaolaiIcon = createIcon(
  <>
    <defs>
      <clipPath id="b">
        <rect
    ...
    >
      <path
        ...
        d="M5.16,16.752a.9.9,0,0,1-.448-.176,1.1,1.1,0,0,1-.144-.608l.144-.3Q6.5,14.288,7.08,13.744l.368-.032.32.176a.82.82,0,0,1,.16.56,3.3,3.3,0,0,1-.552.68q-.328.312-1.136.952a3.2,3.2,0,0,1-1.08.672m12-.064a2.9,2.9,0,0,1-1.032-.648,12,12,0,0,1-1.008-1.208L14.1,13.464q-.424-.568-.792-1.1a8,8,0,0,1-.5.84q-.28.408-1.32,1.6a19,19,0,0,1-1.556,1.644.97.97,0,0,1-.56.176,1.7,1.7,0,0,1-.416-.144.86.86,0,0,1-.16-.56l.16-.32q.736-.64,1.872-1.824a15.8,15.8,0,0,0,1.76-2.528Q11.9,9.872,11.176,8.6A23,23,0,0,1,9.928,6.048l.144-.32a1,1,0,0,1,.592-.16l.32.16q.56,1.072,1.168,2.1t1.2,2.12A23.3,23.3,0,0,0,15.336,5.1l-5.92.16a.654.654,0,0,1-.592-.752l.16-.32a3.3,3.3,0,0,1,1.184-.208l.32.016,6.048-.176q.512.032.512.448A38,38,0,0,1,15.656,8a22.5,22.5,0,0,1-1.616,3.248,39.4,39.4,0,0,0,3.584,4.384.86.86,0,0,1,.16.56l-.16.32a1.1,1.1,0,0,1-.464.176M6.952,8.864a9,9,0,0,0-1.3-.16,4,4,0,0,1-1.216-.24.86.86,0,0,1-.16-.56l.16-.32A.92.92,0,0,1,5,7.408l.192.016a8,8,0,0,0,1.136.112,2.6,2.6,0,0,1,1.088.272.82.82,0,0,1,.16.56l-.16.3a.94.94,0,0,1-.464.2M7.3,5.072q-.736-.224-1.472-.392T4.34,4.32a1,1,0,0,1-.16-.592l.16-.32a.86.86,0,0,1,.512-.16l.176.016A12.2,12.2,0,0,1,7.764,4a.88.88,0,0,1,.16.576l-.16.3a1,1,0,0,1-.464.2"
      />
    </g>
  </>,
  modifiedTablerIconProps
...
// @ts-ignore tabler-icons: layout-align-top
...
// @ts-ignore tabler-icons: layout-align-bottom
